...
<h2>Edition</h2>
<p>
    Ce site est édité par <?= Config::get('website.nom') ?><br>
    <?= Config::get('website.adresse') ?><br>
    <?= Config::get('website.cp') ?> - <?= Config::get('website.ville') ?>
</p>

<p><strong>RCS : </strong> <?= Config::get('website.rcs') ?></p>

<p><strong>Numéro SIRET :</strong> <?= Config::get('website.siret') ?></p>

<p><strong>Numéro SIREN :</strong> <?= Config::get('website.siren') ?></p>

<p><strong>Capital social :</strong> <?= Config::get('website.capital') ?></p>

<p><strong>Directeur de la publication :</strong> <?= Config::get('website.publication') ?></p>

<p><strong>Responsable de la rédaction :</strong> <?= Config::get('website.redaction') ?></p>

<p><strong>Téléphone :</strong> <?= Config::get('website.telephone') ?></p>

<p><strong>Fax :</strong> <?= Config::get('website.fax') ?></p>
...
<p>
    ...
    société <?= Config::get('website.nom') ?> pour que soient rectifiées, complétées, mises à jour ou
...
<p>
    Les informations qui vous concernent sont uniquement destinées à la société <?= Config::get('website.nom') ?>.
